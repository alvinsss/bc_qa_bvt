...
class APK_UPLOADFILE(models.Model):
    ...
    applicationname = models.CharField("应用名称", max_length=50, null=False)
    apksize = models.CharField("文件大小", max_length=10, null=False)
    packagename = models.CharField("packagename", max_length=40, null=False)
    ...
    md5 = models.CharField("MD5", max_length=64,default=None)
...
class APK_RESULTS(models.Model):
    ...
    """
    module = models.ForeignKey( Module, on_delete=models.CASCADE )
    task   = models.ForeignKey(APK_UPLOADFILE,on_delete=models.CASCADE)
    userid = models.IntegerField("用户id",default=None)
    username = models.CharField("用户名",max_length=10,null=False,default=None)
    name_des = models.CharField("名称描述", max_length=50, null=False)
    apk_testtype = models.CharField("测试类型", max_length=200,null=False)
